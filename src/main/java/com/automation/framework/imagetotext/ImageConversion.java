...
public class ImageConversion {
	...
	public static String convertImage(String query) {
		try {
			// Convert PNG to JPG
			//query = "convert image from png to jpg /home/liveuser/Pictures/Screenshots/image.png";
			...
			String inputFilePath = strQuery[1].trim();
			inputFilePath = StringUtils.trim(inputFilePath);
			String outputFilePath = null;
			int lastBackslashIndex = inputFilePath.lastIndexOf(File.separator);
			...
			String str = fileName.substring(0, fileName.indexOf(".")-1);
			fileName = str;
			if (inputCheck.equalsIgnoreCase("png to jpg")) {

				outputFilePath = directory + File.separator + fileName + ".jpg";
				System.out.println(inputFilePath+"===="+outputFilePath);
				convertPngToJpg(inputFilePath, outputFilePath);
			} else {
				System.out.println("else"+inputFilePath+"===="+outputFilePath);

				outputFilePath = directory + File.separator + fileName + ".png";
